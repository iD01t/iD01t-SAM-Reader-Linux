...
root = tk.Tk()
root.title('iD01t SAM Reader Linux')
...
device_info_text.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)
...
device_info_text.config(yscrollcommand=scrollbar.set)
scrollbar.config(command=device_info_text.yview)
